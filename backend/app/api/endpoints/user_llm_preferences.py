...
async def recommend_model(
    *,
    ...
    try:
        from app.services.infrastructure.ai.llm import (
        ...
        complexity = complexity_mapping.get(request.complexity, TaskComplexity.MEDIUM)
        ...
        task_characteristics = TaskCharacteristics(
            ...
            accuracy_critical=request.accuracy_critical,
        ...
        selection_criteria = SelectionCriteria(
            ...
            min_capability_score=request.min_capability_score,
            preferred_providers=request.preferred_providers,
            excluded_models=request.excluded_models,
            require_function_calling=request.require_function_calling,
...
async def record_model_feedback(
    *,
    ...
    provider_name: str,
    success: bool,
    satisfaction_score: float = Query(..., ge=0.0, le=1.0),
    ...
    try:
        from app.services.infrastructure.ai.llm import (
            record_usage_feedback, TaskType
        )
        ...
        if task_type:
            ...
            task_type_enum = task_type_mapping.get(task_type)
        ...
        record_usage_feedback(
            ...
            agent_id=agent_id,
            task_type=task_type.value if task_type_enum else None
        )
