...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.enhanced_tasks.execute_scheduled_task')
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.enhanced_tasks.intelligent_report_generation_pipeline')
def intelligent_report_generation_pipeline(self, task_id: int, user_id: str, execution_context: Dict[str, Any] = None):
    ...
    """
    # 使用增强版本的函数，传递执行上下文
    from app.services.application.task_management.execution.unified_pipeline import unified_report_generation_pipeline, PipelineMode
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.enhanced_tasks.enhanced_intelligent_report_generation_pipeline')
