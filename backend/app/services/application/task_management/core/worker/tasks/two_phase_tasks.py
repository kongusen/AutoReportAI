...
from app.services.application.task_management.execution.unified_pipeline import (
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.two_phase_tasks.execute_two_phase_report_task')
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.two_phase_tasks.execute_phase_1_analysis_task')
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.two_phase_tasks.execute_smart_report_task')
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.two_phase_tasks.execute_batch_template_preparation')
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.two_phase_tasks.execute_scheduled_two_phase_task')
...
@celery_app.task(bind=True, name='app.services.application.task_management.core.worker.tasks.two_phase_tasks.migrate_to_two_phase_task')
