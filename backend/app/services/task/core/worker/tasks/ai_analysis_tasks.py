...
@celery_app.task(name='app.services.task.core.worker.tasks.ai_analysis_tasks.custom_ai_analysis_task')
...
@celery_app.task(name='app.services.task.core.worker.tasks.ai_analysis_tasks.ai_pipeline_task')
...
@celery_app.task(name='app.services.task.core.worker.tasks.ai_analysis_tasks.batch_ai_analysis_task')
