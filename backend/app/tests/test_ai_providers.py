...
def test_test_ai_provider_connection_success(client: TestClient, db_session: Session):
    ...
    response = client.post(
        f"{settings.API_V1_STR}/ai-providers/{provider_id}/test",
        headers=headers
    )
...
def test_activate_ai_provider(client: TestClient, db_session: Session):
    ...
    activate_response = client.post(
        f"{settings.API_V1_STR}/ai-providers/{provider2_id}/activate",
        headers=headers
    )
    ...
    get_response = client.get(
        f"{settings.API_V1_STR}/ai-providers/{provider1_id}",
        headers=headers
    )
...
def test_deactivate_ai_provider(client: TestClient, db_session: Session):
    ...
    deactivate_response = client.post(
        f"{settings.API_V1_STR}/ai-providers/{provider_id}/deactivate",
        headers=headers
    )
...
def test_get_ai_provider_models(client: TestClient, db_session: Session):
    ...
    response = client.get(
        f"{settings.API_V1_STR}/ai-providers/{provider_id}/models",
        headers=headers
    )
...
def test_ai_providers_health_check(client: TestClient, db_session: Session):
    ...
    response = client.get(
        f"{settings.API_V1_STR}/ai-providers/health",
        headers=headers
    )
    assert response.status_code == 200
