"""all uuid foreign keys for data_source_id

Revision ID: 572b5def39a5
Revises: 
Create Date: 2025-07-23 10:55:18.671782
...
def upgrade() -> None:
    ...
    sa.Column('source_type', sa.Enum('sql', 'csv', 'api', 'push', name='datasourcetype'), nullable=False),
